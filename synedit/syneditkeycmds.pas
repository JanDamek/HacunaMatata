...
$Id: syneditkeycmds.pp 35456 2012-02-18 16:56:27Z martin $
...
uses
  Windows,
  System.Classes, FMX.Menus, System.SysUtils;
...
function _ShortCut(Key: Word; Shift: TShiftState): TShortCut;
begin
  Result := 0;
...
procedure _ShortCutToKey(ShortCut: TShortCut; var Key: Word; var Shift: TShiftState);
begin
...
begin
  ...
  _ShortCutToKey(Value, NewKey, NewShift);
