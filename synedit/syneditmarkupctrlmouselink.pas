...
uses
  System.Classes, System.SysUtils, SynEditMarkup, SynEditMiscClasses,
  SynEditMouseCmds, LazSynEditText, FMX.Controls, System.UITypes, System.Types;
...
begin
  ...
  NewCtrlIsPressed := {IsCtrlMouseShiftState(GetKeyShiftState, False);}false;
...
begin
  FLastControlIsPressed := {IsCtrlMouseShiftState(GetKeyShiftState, True);}true;
  InternalUpdateCtrlMouse;
end;
...
begin
  ...
  MarkupInfo.Foreground := TColorRec.Blue; {TODO:  invert blue to bg .... see below}
