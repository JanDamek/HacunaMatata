...
uses
  System.Classes, System.SysUtils, SynEditMiscClasses, LazSynEditText, SynEditPointClasses,
  SynEditKeyCmds, FMX.Types, System.UIConsts, System.UITypes, System.Types;
  ...
  public
    ...
    function GetDesiredIndentForLine
             (Editor: TSynEditBase; const Lines: TSynEditStrings;
              const ACaret: TSynEditCaret): Integer; overload; virtual; abstract;
    function GetDesiredIndentForLine
             (Editor: TSynEditBase; const Lines: TSynEditStrings;
              const ACaret: TSynEditCaret; out ReplaceIndent: Boolean;
              out DesiredIndent: String): Integer; overload; virtual; abstract;
...
procedure TSynBeautifier.ApplyIndent(LinePos: Integer; Indent: Integer;
                          RelativeToLinePos: Integer = 0; IndentChars: String = '';
                          IndentCharsFromLinePos: Integer = 0);
var
  CharMix: String;
