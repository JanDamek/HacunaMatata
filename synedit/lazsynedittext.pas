...
uses
  Classes, SysUtils, SynEditTypes, SynEditMiscProcs, System.Types,
...
type
  ...
  public
    ...
    function PhysicalToLogical(AIndex, AColumn: Integer): Integer; overload;
    function PhysicalToLogical(AIndex, AColumn: Integer; out AColOffset: Integer): Integer; overload;
    // ACharPos 1=before 1st char
    function LogicalToPhysical(AIndex, ABytePos: Integer): Integer; overload;
    function LogicalToPhysical(AIndex, ABytePos: Integer; var AColOffset: Integer): Integer; overload;
  end;
  ...
  *)
  ...
  protected
    ...
    procedure SetUpdateState(Updating: Boolean); overload; override;
    procedure SetUpdateState(Updating: Boolean; Sender: TObject); overload; virtual; abstract;
  ...
  public
    ...
    procedure SendNotification(AReason: TSynEditNotifyReason;
                ...
                aTxt: String = ''); overload; virtual; abstract;
    procedure SendNotification(AReason: TSynEditNotifyReason;
                ASender: TObject); overload; virtual; abstract;
   procedure FlushNotificationCache; virtual; abstract;
  public
    function GetPhysicalCharWidths(Index: Integer): TPhysicalCharWidths; overload;
    function GetPhysicalCharWidths(Line: PChar; LineLen, Index: Integer): TPhysicalCharWidths; overload;
    // Byte to Char
