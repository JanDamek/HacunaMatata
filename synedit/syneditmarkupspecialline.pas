...
uses
  System.Classes, System.SysUtils, SynEditMarkup, SynEditMiscClasses, FMX.Controls, System.UITypes;
...
begin
  Result :=
    (FMarkupLineHighlightInfo.Background <> TColorRec.Null) or
    (FMarkupLineHighlightInfo.Foreground <> TColorRec.Null);
end;
...
begin
  ...
  FMarkupLineHighlightInfo.Background := TColorRec.Null;
  FMarkupLineHighlightInfo.Foreground := TColorRec.Null;
...
begin
  ...
  begin
    ...
    begin
      colFg := TColorRec.Null;
      colBg := TColorRec.Null;
    end;
