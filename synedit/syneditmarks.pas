...
uses
  Classes, FMX.Controls, SysUtils, math, SynEditMiscClasses, LazSynEditText;
...
type
  ...
  public
    ...
    property ImageList: TList read FImageList write FImageList;
  end;
  ...
  public
    ...
    procedure Clear; overload; override; // FreeMarks=False;
    procedure Clear(FreeMarks: Boolean); overload;
