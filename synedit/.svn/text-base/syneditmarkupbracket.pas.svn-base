...
uses
  System.Classes, System.SysUtils, System.Types, SynEditMarkup, SynEditMiscClasses, FMX.Controls, FMX.Types;
...
begin
  ...
  MarkupInfo.Foreground := TColorRec.Null;
  MarkupInfo.Background := TColorRec.Null;
  MarkupInfo.Style := [TFontStyle.fsBold];
