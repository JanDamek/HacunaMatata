...
procedure SynEditStringDoubleWidthChars.DoGetPhysicalCharWidths(Line: PChar; LineLen, Index: Integer;
  ...
  begin
    ...
    case Line^ of
      ...
      #$e2:
        case Line[1] of
          #$8c:
            if (Line[2] = #$a9) or (Line[2] = #$aa) then
              PWidths^ := 2;
          #$ba:
            if (Line[2] >= #$80) then
              PWidths^ := 2;
      ...
      Char($e5) .. Char($e8):
        PWidths^ := 2;
      #$e9:
        if (Line[1] <= #$bf) or (Line[2] <= #$83) then
          PWidths^ := 2;
      #$ea:
        case Line[1] of
          #$80, #$b0:
            if (Line[2] >= #$80) then
              PWidths^ := 2;
          Char($81) .. Char($92), Char($b1) .. Char($ff):
            PWidths^ := 2;
          #$93:
            if (Line[2] <= #$86) then
              PWidths^ := 2;
      ...
      Char($eb) .. Char($ec):
        PWidths^ := 2;
      Char($ed):
        if (Line[1] <= #$9e) or (Line[2] <= #$a3) then
          PWidths^ := 2;
        ...
        case Line[1] of
          ...
          #$bd:
            if (Line[2] <= #$a0) then
              PWidths^ := 2;
          #$bf:
            if (Line[2] >= #$a0) and (Line[2] <= #$a6) then
              PWidths^ := 2;
        end;
      #$f0:
        case Line[1] of
          ...
          Char($a1) .. Char($ae), Char($b1) .. Char($be):
            PWidths^ := 2;
          #$af, #$bf:
            case Line[2] of
              #$00 .. #$be:
