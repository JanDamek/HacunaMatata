...
uses
  System.SysUtils, System.Classes, FMX.Controls, FMX.Menus, SynGutterBase, SynEditMiscProcs,
  SynEditFoldedView, SynEditMouseCmds, SynEditHighlighterFoldBase, System.Types, FMX.Types;
...
type
  ...
  public
    ...
    procedure Paint(Canvas: TCanvas; AClip: TRect; FirstLine, LastLine: integer);
      override;
    procedure DoOnGutterClick(X, Y: Single); override;
...
implementation
uses
  SynEdit, System.UITypes;

var
  GlobalPopUpImageList: TList = nil;
...
begin
  ...
  MarkupInfo.Background := TColorRec.Null;
  MarkupInfo.Foreground := TColorRec.DkGray;
  MarkupInfo.FrameColor := TColorRec.Null;
end;
...
procedure TSynGutterCodeFolding.DoOnGutterClick(X, Y : Single);
begin
  // Do Nothing
end;
