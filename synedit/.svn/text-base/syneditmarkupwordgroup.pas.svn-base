...
uses
  System.Classes, System.SysUtils, SynEditMarkup, SynEditMiscClasses, FMX.Controls,
  SynEditHighlighter, SynEditHighlighterFoldBase, FMX.Types, System.UITypes, System.Types;
...
begin
  ...
  FHighlightPos1.Y := -1;
  FHighlightPos2.Y := -1;
  MarkupInfo.Foreground := TColorRec.Null;// clNone;
  MarkupInfo.FrameColor := TColorRec.Red;// clNone;
