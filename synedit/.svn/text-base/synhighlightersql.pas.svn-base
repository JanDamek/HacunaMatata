...
$Id: synhighlightersql.pas 34411 2011-12-25 19:00:46Z juha $
...
{begin}                                                                         // DJLP 2000-08-11
  ...
  fDefaultPackageAttri.Style := [TFontStyle.fsBold];
...
{begin}                                                                         // DJLP 2000-08-11
  ...
  fPLSQLAttri.Style := [TFontStyle.fsBold];
...
{begin}                                                                         // DJLP 2000-09-05
  ...
  fSQLPlusAttri.Style := [TFontStyle.fsBold];
