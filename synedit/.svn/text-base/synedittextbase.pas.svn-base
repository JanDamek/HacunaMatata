...
uses
  System.Classes, System.SysUtils, SynEditMiscProcs, SynEditKeyCmds;
...
type
  ...
  public
    ...
    function  GetPChar(ALineIndex: Integer): PChar;  overload;
    function  GetPChar(ALineIndex: Integer; out ALen: Integer): PChar; overload; virtual; abstract;
...
begin
  ...
  FMem := SysReallocMem(FMem, AValue * ItemSize);
