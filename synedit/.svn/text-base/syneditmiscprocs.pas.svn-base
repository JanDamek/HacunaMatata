...
$Id: syneditmiscprocs.pp 30453 2011-04-24 18:23:44Z martin $
...
uses
  System.Classes, SynEditTypes, FMX.Types, System.Types, System.UITypes;
...
procedure InternalFillRect(dc: {HDC}THandle; const rcPaint: TRect);
...
procedure SynAssert(Condition: Boolean; Msg: String); overload;
procedure SynAssert(Condition: Boolean; Msg: String; Args: Array of Const); overload;
