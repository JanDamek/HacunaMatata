...
uses
  System.Classes, System.SysUtils, FMX.Controls,
...
uses SynEdit, SynEditTypes, System.Types;
...
begin
  ...
  if (not TCustomSynEdit(SynEdit).HideSelection or TCustomSynEdit(SynEdit).isFocused) then begin
